    ...
    if (!this.props.loggedIn) {
      ...
      menuDropdown = (
        <span id="menu-dropdown">
          {this.props.self.email}
          <br />
          <ul id="menu-dropdown">
            <li
              className="menu-dropdown-li"
              onClick={() => {
                if (this.props.history.location.pathname === "/events/browse") {
                  window.location.reload();
                }
                this.props.history.push(`/events/browse`);
              }}
            >
              Browse events
            </li>
            <li
              className="menu-dropdown-li"
              onClick={() => {
                this.props.history.push(`/${this.props.myId}/events`);
              }}
            >
              Manage my events
            </li>
            <li
              className="menu-dropdown-li"
              onClick={() =>
                this.props.history.push(`/${this.props.myId}/likes/events`)
              }
            >
              Likes
            </li>
            ...
            <li className="menu-dropdown-li" onClick={this.signOut}>
              Sign Out
            </li>
          </ul>
        </span>
