...
class SessionSignupForm extends React.Component{
  ...
  render(){
    ...
    let passwordErr, emailErr, confirmEmailErr, firstErr, lastErr='';
    if(this.props.errors){
      this.props.errors.forEach( (error)=>{
        let err = this.props.errorList[error]; 
        let message = <p id="session-error-message" className='form-error-message'>{error}</p>
        switch(err){
      ...
      <div id="session-signup-form">
        ...
        {message}
          ...
          <label className="session-form-input-label"><p>Confirm email</p>
            <input className="session-form-input" type="text"
                  onChange={this.handleChange('emails')} value={this.state.emails}/>
          </label>
          {confirmEmailErr}
          ...
          <span id="session-signup-info-form-name-error">
            ...
            <span>{firstErr}</span><span>{lastErr}</span>
          </span>
