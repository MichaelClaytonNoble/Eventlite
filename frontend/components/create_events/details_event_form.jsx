...
class DetailsEventForm extends React.Component {
  ...
  render() {
    const preview = this.state.imageUrl ? (
      <img alt="signup-form" id="add-image-preview" src={this.state.imageUrl} />
    ) : null;
    let eventExistErr,
      summaryErr,
      aboutErr = "";
        ...
        <form id="details-event-info-form" onSubmit={this.handleSubmit}>
          <section className="info-section">
            <h1 className="create-header">
              <i className="far fa-images create-event-form-icons"></i>Main
              Event Image
            </h1>
          ...
          <section className="info-section">
            <h1 className="create-header">
              <i className="far fa-edit create-event-form-icons"></i>Description
            </h1>
            <p className="create-description">
              Add more details to your event like your schedule, sponsors, or
              featured guests.
            </p>
            <label id="larger-input-label" className="larger-input-label">
              <p>Summary</p>
              <textarea
            ...
            {summaryErr}
            <label id="larger-input-label-2" className="larger-input-label">
              <p>About</p>
              <textarea
                className="larger-input"
